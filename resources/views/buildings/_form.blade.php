...
<div class="row g-3">
    ...
    <div class="col-12">
        <label for="location" class="form-label">Lokasi / Alamat</label>
        <input
            id="location"
            type="text"
            name="location"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input
                ...
                @checked(old('is_active', $building->is_active))
            >
...
<div class="d-flex justify-content-end gap-2 mt-4">
    <a href="{{ route('buildings.index') }}" class="btn btn-outline-secondary">Batal</a>
